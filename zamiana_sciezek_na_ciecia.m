...
liczba_sciezek= input(' ');%%zakladam ze bedzie maksymalnie 10 sciezek wiec 10 iteracji zewnêtrznej petli for
disp('wpisz liczbe elementow');
liczba_elementow= input(' ');

for y = 1 : liczba_sciezek
    for x = 1 : liczba_elementow
        disp('wpisz 1 jeœli œciezka ma element,a zero jesli nie ma.2 zakonczy program')
...
suma_boolowska=0;  %%komorka w maciezy poloczen.Zmienna pomaga sumowaæ wiersze macierzy po³¹czeñ.
                    %%Wektor rozwi¹zañ odpowiada za ustalenie czy dana kombinacja tworzy ciecie.
                    %%gdy wektor rozzwi¹zañ bedzie siê sk³adaæ z samych
                    %%jedynek, to bêdzie znaczyæ ¿e mamy ciêcie
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%ciêcia drugiego rzêdu%%%%%%%%%%%%%%%%
...
wektor_rozwiazan=[0 0 0 0 ];%%czyszczenie tablicy 
disp('program pokazuje tak¿e ciêcia któe nie s¹ minimalne')
